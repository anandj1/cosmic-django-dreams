// This file contains the custom hook for toast notifications
// From shadcn ui
...
function toast({ ...props }: Toast) {
  ...
  // Check if this toast with similar title already exists
  ...
  if (existingToast) {
    // If similar toast exists, don't create a new one
    return
  }
